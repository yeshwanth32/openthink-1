...
var and__6531__auto__ = cljs.core.not_empty.call(null,trimmed);
...
if(cljs.core.truth_((function (){var or__6543__auto__ = new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(state);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var or__6543__auto__ = markdown.transformers.h1_QMARK_.call(null,text);
if(cljs.core.truth_(or__6543__auto__)){
return or__6543__auto__;
} else {
...
var G__44339 = cljs.core.into.call(null,buf,cljs.core.concat.call(null,cljs.core.seq.call(null,"<sup>"),cljs.core.second.call(null,remaining),cljs.core.seq.call(null,"</sup>")));
var G__44340 = cljs.core.drop.call(null,(2),remaining);
buf = G__44339;
remaining = G__44340;
continue;
} else {
var G__44341 = cljs.core.into.call(null,buf,cljs.core.first.call(null,remaining));
var G__44342 = cljs.core.rest.call(null,remaining);
buf = G__44341;
remaining = G__44342;
continue;
...
if(cljs.core.truth_((function (){var or__6543__auto__ = new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
if(cljs.core.truth_(or__6543__auto__)){
return or__6543__auto__;
} else {
...
markdown.transformers.br = (function markdown$transformers$br(text,p__44343){
var map__44346 = p__44343;
...
var state = map__44346__$1;
var code = cljs.core.get.call(null,map__44346__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.call(null,map__44346__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [" "," "], null),cljs.core.take_last.call(null,(2),text))) && (cljs.core.not.call(null,(function (){var or__6543__auto__ = code;
if(cljs.core.truth_(or__6543__auto__)){
return or__6543__auto__;
} else {
return lists;
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(state))?text:clojure.string.replace.call(null,text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__44348_SHARP_){
var url = cljs.core.subs.call(null,p1__44348_SHARP_,(1),(cljs.core.count.call(null,p1__44348_SHARP_) - (1)));
...
})())?text:clojure.string.replace.call(null,text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__44349_SHARP_){
var encoded = (cljs.core.truth_(new cljs.core.Keyword(null,"clojurescript","clojurescript",-299769403).cljs$core$IFn$_invoke$arity$1(state))?cljs.core.subs.call(null,p1__44349_SHARP_,(1),(cljs.core.count.call(null,p1__44349_SHARP_) - (1))):cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (c){
if((cljs.core.rand.call(null) > 0.5)){
return markdown.transformers.formatter.call(null,"&#x%02x;",(c | (0)));
} else {
return c;
}
}),cljs.core.subs.call(null,p1__44349_SHARP_,(1),(cljs.core.count.call(null,p1__44349_SHARP_) - (1))))));
return [cljs.core.str("<a href=\"mailto:"),cljs.core.str(encoded),cljs.core.str("\">"),cljs.core.str(encoded),cljs.core.str("</a>")].join('');
}))),state], null);
});
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__44350){
var map__44353 = p__44350;
var map__44353__$1 = ((((!((map__44353 == null)))?((((map__44353.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44353.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44353):map__44353);
var state = map__44353__$1;
var inline_heading = cljs.core.get.call(null,map__44353__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
if(cljs.core.truth_((function (){var and__6531__auto__ = cljs.core.not.call(null,last_line_empty_QMARK_);
...
markdown.transformers.paragraph = (function markdown$transformers$paragraph(text,p__44355){
var map__44358 = p__44355;
...
var state = map__44358__$1;
var eof = cljs.core.get.call(null,map__44358__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.call(null,map__44358__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.call(null,map__44358__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.call(null,map__44358__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.call(null,map__44358__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.call(null,map__44358__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.call(null,map__44358__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.call(null,map__44358__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__44358__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.call(null,map__44358__$1,new cljs.core.Keyword(null,"code","code",1586293142));
if(cljs.core.truth_((function (){var and__6531__auto__ = paragraph;
if(cljs.core.truth_(and__6531__auto__)){
return lists;
} else {
return and__6531__auto__;
...
if(cljs.core.truth_((function (){var or__6543__auto__ = eof;
if(cljs.core.truth_(or__6543__auto__)){
return or__6543__auto__;
} else {
...
if(cljs.core.truth_((function (){var and__6531__auto__ = cljs.core.not.call(null,eof);
if(and__6531__auto__){
var and__6531__auto____$1 = !(clojure.string.blank_QMARK_.call(null,text));
if(and__6531__auto____$1){
var or__6543__auto__ = new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818).cljs$core$IFn$_invoke$arity$1(temp);
if(cljs.core.truth_(or__6543__auto__)){
return or__6543__auto__;
} else {
...
markdown.transformers.code = (function markdown$transformers$code(text,p__44360){
var map__44363 = p__44360;
...
var state = map__44363__$1;
var eof = cljs.core.get.call(null,map__44363__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__44363__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.call(null,map__44363__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__44363__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
if(cljs.core.truth_((function (){var or__6543__auto__ = lists;
if(cljs.core.truth_(or__6543__auto__)){
return or__6543__auto__;
} else {
return codeblock;
...
if(cljs.core.truth_((function (){var and__6531__auto__ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take.call(null,(3),trimmed));
if(and__6531__auto__){
return new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
} else {
return and__6531__auto__;
...
if(cljs.core.truth_((function (){var and__6531__auto__ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last.call(null,(3),trimmed));
if(and__6531__auto__){
return new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
} else {
return and__6531__auto__;
...
var vec__44368 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_," "),cljs.core.drop.call(null,(3),trimmed));
var lang = cljs.core.nth.call(null,vec__44368,(0),null);
var code = cljs.core.nth.call(null,vec__44368,(1),null);
...
markdown.transformers.blockquote = (function markdown$transformers$blockquote(text,p__44371){
var map__44374 = p__44371;
...
var state = map__44374__$1;
var eof = cljs.core.get.call(null,map__44374__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.call(null,map__44374__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__44374__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.call(null,map__44374__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim.call(null,text);
if(cljs.core.truth_((function (){var or__6543__auto__ = code;
if(cljs.core.truth_(or__6543__auto__)){
return or__6543__auto__;
} else {
var or__6543__auto____$1 = codeblock;
if(cljs.core.truth_(or__6543__auto____$1)){
return or__6543__auto____$1;
} else {
return lists;
...
return (function (p1__44376_SHARP_){
return [cljs.core.str("<ol class='footnotes'>"),cljs.core.str(p1__44376_SHARP_),cljs.core.str("</ol>")].join('');
}).call(null,cljs.core.reduce.call(null,(function (footnotes__$1,p__44381){
var vec__44382 = p__44381;
var id = cljs.core.nth.call(null,vec__44382,(0),null);
var label = cljs.core.nth.call(null,vec__44382,(1),null);
...
var vec__44391 = cljs.core.re_matches.call(null,/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.call(null,vec__44391,(0),null);
var key = cljs.core.nth.call(null,vec__44391,(1),null);
var val = cljs.core.nth.call(null,vec__44391,(2),null);
var vec__44394 = cljs.core.re_matches.call(null,/^    (.*)$/,line);
var ___$1 = cljs.core.nth.call(null,vec__44394,(0),null);
var next_val = cljs.core.nth.call(null,vec__44394,(1),null);
...
var vec__44400 = ((cljs.core.sequential_QMARK_.call(null,data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.call(null,vec__44400,(0),null);
var val = cljs.core.nth.call(null,vec__44400,(1),null);
...
var G__44403 = cljs.core.merge.call(null,acc,cljs.core.PersistentArrayMap.fromArray([key,new_val], true, false));
var G__44404 = cljs.core.rest.call(null,remain);
var G__44405 = key;
acc = G__44403;
remain = G__44404;
prev_key = G__44405;
