...
return clojure.string.join.call(null,(function (){var iter__7326__auto__ = (function markdown$lists$close_lists_$_iter__44302(s__44303){
return (new cljs.core.LazySeq(null,(function (){
var s__44303__$1 = s__44303;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__44303__$1);
if(temp__4657__auto__){
var s__44303__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__44303__$2)){
var c__7324__auto__ = cljs.core.chunk_first.call(null,s__44303__$2);
var size__7325__auto__ = cljs.core.count.call(null,c__7324__auto__);
var b__44305 = cljs.core.chunk_buffer.call(null,size__7325__auto__);
if((function (){var i__44304 = (0);
while(true){
if((i__44304 < size__7325__auto__)){
var vec__44312 = cljs.core._nth.call(null,c__7324__auto__,i__44304);
var list_type = cljs.core.nth.call(null,vec__44312,(0),null);
cljs.core.chunk_append.call(null,b__44305,[cljs.core.str("</li></"),cljs.core.str(cljs.core.name.call(null,list_type)),cljs.core.str(">")].join(''));

var G__44318 = (i__44304 + (1));
i__44304 = G__44318;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__44305),markdown$lists$close_lists_$_iter__44302.call(null,cljs.core.chunk_rest.call(null,s__44303__$2)));
} else {
...
var list_type = cljs.core.nth.call(null,vec__44315,(0),null);
return cljs.core.cons.call(null,[cljs.core.str("</li></"),cljs.core.str(cljs.core.name.call(null,list_type)),cljs.core.str(">")].join(''),markdown$lists$close_lists_$_iter__44302.call(null,cljs.core.rest.call(null,s__44303__$2)));
}
} else {
return null;
}
...
return iter__7326__auto__.call(null,lists);
})());
});
...
var lists_to_close = cljs.core.take_while.call(null,(function (p1__44319_SHARP_){
return (cljs.core.second.call(null,p1__44319_SHARP_) > num_indents);
...
var vec__44323 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__44323,(0),null);
var indents = cljs.core.nth.call(null,vec__44323,(1),null);
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ul","ul",-1349521403),list_type,num_indents,indents,(function (){var or__6543__auto__ = markdown.common.make_heading.call(null,content,false);
...
var vec__44329 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__44329,(0),null);
var indents = cljs.core.nth.call(null,vec__44329,(1),null);
var num_indents = cljs.core.count.call(null,cljs.core.take_while.call(null,cljs.core.partial.call(null,cljs.core._EQ_," "),text));
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ol","ol",932524051),list_type,num_indents,indents,(function (){var or__6543__auto__ = markdown.common.make_heading.call(null,content,false);
if(cljs.core.truth_(or__6543__auto__)){
return or__6543__auto__;
} else {
return content;
...
markdown.lists.li = (function markdown$lists$li(text,p__44332){
var map__44335 = p__44332;
...
var state = map__44335__$1;
var code = cljs.core.get.call(null,map__44335__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__44335__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__44335__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.call(null,map__44335__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__44335__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
if(cljs.core.truth_((function (){var and__6531__auto__ = last_line_empty_QMARK_;
...
if(cljs.core.truth_((function (){var and__6531__auto__ = lists;
if(cljs.core.truth_(and__6531__auto__)){
var or__6543__auto__ = last_line_empty_QMARK_;
if(cljs.core.truth_(or__6543__auto__)){
return or__6543__auto__;
} else {
return eof;
...
var and__6531__auto____$1 = lists;
...
if(cljs.core.truth_((function (){var and__6531__auto__ = (function (){var or__6543__auto__ = eof;
if(cljs.core.truth_(or__6543__auto__)){
return or__6543__auto__;
} else {
