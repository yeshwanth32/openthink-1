...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17111 = (0);while(true){
var m_17112 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17112 == null))
{} else
{m_17112.call(null);
if((count_17111 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17113 = (count_17111 + (1));
count_17111 = G__17113;
continue;
}
} else
{}
