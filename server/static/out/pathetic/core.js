...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__43654_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__43654_SHARP_),cljs.core.second.call(null,p1__43654_SHARP_));
}),cljs.core.map.call(null,(function (p1__43655_SHARP_,p2__43656_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__43655_SHARP_,p2__43656_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__43658 = cljs.core.first.call(null,path_pieces);
switch (G__43658) {
case "":
...
var G__43661 = (((cljs.core.first.call(null,path_pieces) instanceof cljs.core.Keyword))?cljs.core.first.call(null,path_pieces).fqn:null);
switch (G__43661) {
case "root":
...
var G__43664 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__43664)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__43664)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__43664)){
return path_pieces;
} else {
...
while(true){
var vec__43671 = remaining_path;
var seq__43672 = cljs.core.seq.call(null,vec__43671);
var first__43673 = cljs.core.first.call(null,seq__43672);
var seq__43672__$1 = cljs.core.next.call(null,seq__43672);
var curr = first__43673;
var remainder = seq__43672__$1;
var pred__43674 = cljs.core._EQ_;
var expr__43675 = curr;
if(cljs.core.truth_(pred__43674.call(null,null,expr__43675))){
return result;
} else {
if(cljs.core.truth_(pred__43674.call(null,"",expr__43675))){
var G__43677 = result;
var G__43678 = remainder;
result = G__43677;
remaining_path = G__43678;
continue;
} else {
if(cljs.core.truth_(pred__43674.call(null,".",expr__43675))){
var G__43679 = result;
var G__43680 = remainder;
result = G__43679;
remaining_path = G__43680;
continue;
} else {
if(cljs.core.truth_(pred__43674.call(null,"..",expr__43675))){
var G__43681 = pathetic.core.up_dir.call(null,result);
var G__43682 = remainder;
result = G__43681;
remaining_path = G__43682;
continue;
} else {
var G__43683 = cljs.core.conj.call(null,result,curr);
var G__43684 = remainder;
result = G__43683;
remaining_path = G__43684;
continue;
}
}
}
...
var expr__43689 = curr;
if(cljs.core.truth_(pred__43688.call(null,null,expr__43689))){
return suffix;
} else {
if(cljs.core.truth_(pred__43688.call(null,"",expr__43689))){
var G__43691 = suffix;
var G__43692 = cljs.core.rest.call(null,remainder);
suffix = G__43691;
remainder = G__43692;
continue;
} else {
if(cljs.core.truth_(pred__43688.call(null,".",expr__43689))){
var G__43693 = suffix;
var G__43694 = cljs.core.rest.call(null,remainder);
suffix = G__43693;
remainder = G__43694;
continue;
} else {
if(cljs.core.truth_(pred__43688.call(null,"..",expr__43689))){
var G__43695 = cljs.core.conj.call(null,suffix,"..");
var G__43696 = cljs.core.rest.call(null,remainder);
suffix = G__43695;
remainder = G__43696;
continue;
} else {
var G__43697 = cljs.core.conj.call(null,suffix,curr);
var G__43698 = cljs.core.rest.call(null,remainder);
suffix = G__43697;
remainder = G__43698;
continue;
}
...
var vec__43702 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__43702,(0),null);
var path = cljs.core.nth.call(null,vec__43702,(1),null);
var post_path = cljs.core.nth.call(null,vec__43702,(2),null);
...
var vec__43708 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__43708,(0),null);
var path = cljs.core.nth.call(null,vec__43708,(1),null);
var post_path = cljs.core.nth.call(null,vec__43708,(2),null);
