...
sablono.util.ToString = (function (){var obj23937 = {};
return obj23937;
})();
...
return (function (){var or__3638__auto__ = (sablono.util.to_str[goog.typeOf(x__4282__auto__)]);
if(or__3638__auto__){
return or__3638__auto__;
} else {
var or__3638__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj23939 = {};
return obj23939;
})();
...
var x__4282__auto__ = (((x == null))?null:x);
return (function (){var or__3638__auto__ = (sablono.util.to_uri[goog.typeOf(x__4282__auto__)]);
if(or__3638__auto__){
return or__3638__auto__;
} else {
var or__3638__auto____$1 = (sablono.util.to_uri["_"]);
if(or__3638__auto____$1){
return or__3638__auto____$1;
} else {
...
as_str.cljs$lang$applyTo = (function (arglist__23940){
var xs = cljs.core.seq(arglist__23940);
...
var vec__23942 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__23942,(0),null);
var words = cljs.core.nthnext.call(null,vec__23942,(1));
...
var G__23944 = clojure.set.rename_keys.call(null,m,kmap);
var G__23944__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__23944,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__23944);
return G__23944__$1;
} else {
return m;
}
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__23945_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__23945_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__23945_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__23945_SHARP_)){
return p1__23945_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__23945_SHARP_], null);
...
merge_with_class.cljs$lang$applyTo = (function (arglist__23946){
var maps = cljs.core.seq(arglist__23946);
...
var tag_name = cljs.core.nth.call(null,vec__23950,(0),null);
var names = cljs.core.nth.call(null,vec__23950,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__23950,tag_name,names){
return (function (p1__23947_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__23947_SHARP_));
});})(matches,vec__23950,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__23950,tag_name,names){
return (function (p1__23948_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__23948_SHARP_));
});})(matches,vec__23950,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__23951){
var vec__23954 = p__23951;
var tag = cljs.core.nth.call(null,vec__23954,(0),null);
var content = cljs.core.nthnext.call(null,vec__23954,(1));
...
var vec__23955 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__23955,(0),null);
var id = cljs.core.nth.call(null,vec__23955,(1),null);
var class$ = cljs.core.nth.call(null,vec__23955,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__3638__auto__ = x__$1.hasDomain();
