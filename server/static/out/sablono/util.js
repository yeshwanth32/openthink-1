...
var len__7651__auto___13131 = arguments.length;
var i__7652__auto___13132 = (0);
while(true){
if((i__7652__auto___13132 < len__7651__auto___13131)){
args__7658__auto__.push((arguments[i__7652__auto___13132]));

var G__13133 = (i__7652__auto___13132 + (1));
i__7652__auto___13132 = G__13133;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq13130){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13130));
});
...
var vec__13137 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__13138 = cljs.core.seq.call(null,vec__13137);
var first__13139 = cljs.core.first.call(null,seq__13138);
var seq__13138__$1 = cljs.core.next.call(null,seq__13138);
var first_word = first__13139;
var words = seq__13138__$1;
...
var G__13141 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__13141,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__13141;
}
} else {
...
var args__7658__auto__ = [];
var len__7651__auto___13144 = arguments.length;
var i__7652__auto___13145 = (0);
while(true){
if((i__7652__auto___13145 < len__7651__auto___13144)){
args__7658__auto__.push((arguments[i__7652__auto___13145]));

var G__13146 = (i__7652__auto___13145 + (1));
i__7652__auto___13145 = G__13146;
continue;
} else {
}
break;
...
var argseq__7659__auto__ = ((((0) < args__7658__auto__.length))?(new cljs.core.IndexedSeq(args__7658__auto__.slice((0)),(0),null)):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__7659__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__13142_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__13142_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__13142_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__13142_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq13143){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13143));
});
...
var vec__13152 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__13152,(0),null);
var names = cljs.core.nth.call(null,vec__13152,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__13152,tag_name,names){
return (function (p1__13147_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__13147_SHARP_));
});})(matches,vec__13152,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__13152,tag_name,names){
return (function (p1__13148_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__13148_SHARP_));
});})(matches,vec__13152,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__13155){
var vec__13162 = p__13155;
var seq__13163 = cljs.core.seq.call(null,vec__13162);
var first__13164 = cljs.core.first.call(null,seq__13163);
var seq__13163__$1 = cljs.core.next.call(null,seq__13163);
var tag = first__13164;
var content = seq__13163__$1;
...
var vec__13165 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__13165,(0),null);
var id = cljs.core.nth.call(null,vec__13165,(1),null);
var class$ = cljs.core.nth.call(null,vec__13165,(2),null);
