...
var len__7651__auto___41628 = arguments.length;
var i__7652__auto___41629 = (0);
while(true){
if((i__7652__auto___41629 < len__7651__auto___41628)){
args__7658__auto__.push((arguments[i__7652__auto___41629]));

var G__41630 = (i__7652__auto___41629 + (1));
i__7652__auto___41629 = G__41630;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq41627){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq41627));
});
...
var vec__41634 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__41636;
var words = seq__41635__$1;
...
var G__41638 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__41638,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__41638;
}
} else {
...
var args__7658__auto__ = [];
var len__7651__auto___41641 = arguments.length;
var i__7652__auto___41642 = (0);
while(true){
if((i__7652__auto___41642 < len__7651__auto___41641)){
args__7658__auto__.push((arguments[i__7652__auto___41642]));

var G__41643 = (i__7652__auto___41642 + (1));
i__7652__auto___41642 = G__41643;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__41639_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__41639_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__41639_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__41639_SHARP_)){
return p1__41639_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__41639_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq41640){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq41640));
});
...
var vec__41649 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__41649,(0),null);
var names = cljs.core.nth.call(null,vec__41649,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__41649,tag_name,names){
return (function (p1__41644_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__41644_SHARP_));
});})(matches,vec__41649,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__41649,tag_name,names){
return (function (p1__41645_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__41645_SHARP_));
});})(matches,vec__41649,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__41652){
var vec__41659 = p__41652;
...
var tag = first__41661;
var content = seq__41660__$1;
...
var vec__41662 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__41662,(0),null);
var id = cljs.core.nth.call(null,vec__41662,(1),null);
var class$ = cljs.core.nth.call(null,vec__41662,(2),null);
